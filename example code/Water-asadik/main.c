...
int		main (int narg, char ** args)
{
  ...
  unsigned int total_texture[4 * 256 * 256];
  unsigned int alpha_texture;
  unsigned int caustic_texture;
  ...
  //alpha_texture = LoadTexBMP("alpha.bmp");
  caustic_texture = LoadTexBMP("water.bmp");
